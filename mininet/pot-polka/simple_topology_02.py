...
def topology(remote_controller=False):
    ...
    for i in switches:
        ...
        json_file = f"{path}/pot-polka/pot-polka-core.json"
    ...
    net.addLink(h1, src_edge, bw=BW)
    net.addLink(h2, dst_edge, bw=BW)

    net.addLink(src_edge, switches["1"], bw=BW)
    net.addLink(dst_edge, switches["3"], bw=BW)
